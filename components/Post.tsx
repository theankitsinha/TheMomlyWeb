                            ...
                            {feed.poll_options.map((singlePollOption, index) => {
                                ...
                                return (
                                    <>
                                        ...
                                        {/*     key={"pollOption" + singlePollOption.id}>*/}
                                        {/*    <div*/}
                                        {/*        className="bg-primary/60 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full"*/}
                                        {/*        style={{width: percentage + "%"}}>{singlePollOption.option}*/}
                                        {/*    </div>*/}
                                        {/*</div>*/}
                                    </>
                                )
